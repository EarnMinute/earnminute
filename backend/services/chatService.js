...
throw new Error("You are not allowed to start a conversation for this task");
}

let conversation = await conversationRepository.findConversationByTaskAndFreelancer(
taskId,
freelancerId
);
...
return messageRepository.getMessagesByConversation(conversationId, limit, skip);
